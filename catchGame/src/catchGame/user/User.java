...
//	public GameManager gameManager; // 맵 정보
...
//		this.location = "집";
	...
	// 몬스터 포획 메소드
	public void catchMonster(String location) throws InterruptedException {
		// 몬스터 배열 객체 선언
//		GameManager gameManager = new GameManager();
		...
		this.loadFightMonster(monsterArrays, location, isCatch);
	}
...
//		}
	...
	private void fightMonster(MonsterBase monster, boolean isCatch, String catchMonsterName)
		...
		this.catchedMonster(monster, isCatch, catchMonsterName);
		return;
	}

	// 몬스터 포획 시 실행
	private void catchedMonster(MonsterBase monster, boolean isCatch, String catchMonsterName) // 수정
			throws InterruptedException {
...
//				return monster;
				...
				myPoketCnt++;
				System.out.println("\u001B[34m" + "✨ 띠링! " + catchMonsterName + "이(가) 포켓몬 도감에 등록되었습니다!" + "\u001B[0m");
...
//		this.location = newMap.mapData.substring(this.mapExploring.len-1,this.mapExploring.len);
//	}

	// 유저 정보 출력
	public void printUserInfo(String location) {
		int lineLimit = 2;
		int countOnLine = 0;
		// 중복 여부 확인
		...
		System.out.println("사용자 위치: " + (location.equals("취소") ? "집" : location));
